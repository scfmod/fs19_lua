...
InputBinding.MOUSE_MOVE_BASE_FACTOR = 75.000000
InputBinding.MOUSE_AXES = {
    AXIS_Y = 1.000000,
    AXIS_X = 0.000000
}
InputBinding.GAMEPAD_BUTTONS = {
    BUTTON_9 = 8.000000,
    BUTTON_23 = 22.000000,
    BUTTON_2 = 1.000000,
    BUTTON_32 = 31.000000,
...
InputBinding.INPUTTYPE_MOUSE_WHEEL = 3.000000
InputBinding.COMBO_MASK_MOUSE_COMMAND_4 = 8.000000
InputBinding.MOUSE_WHEEL_INPUT_FACTOR = 3.000000
...
InputBinding.GAMEPAD_BUTTON_NAMES = {
    0 = 'BUTTON_1',
    2 = 'BUTTON_3',
    31 = 'BUTTON_32',
    12 = 'BUTTON_13',
...
InputBinding.MOUSE_AXIS_Y = 2.000000
...
InputBinding.KB_MOUSE_INTERNAL_ID = 255.000000
InputBinding.PATHS = {
    DEFAULT_BINDINGS_JOYSTICK = 'C:/.../Farming Simulator 19/profileTemplate/inputBindingDefault_Joystick.xml',
    DEFAULT_BINDINGS_PS4 = 'C:/.../Farming Simulator 19/profileTemplate/inputBindingDefault_Gamepad.xml',
    DEFAULT_BINDINGS_WHEEL = 'C:/.../Farming Simulator 19/profileTemplate/inputBindingDefault_Wheel.xml',
    DEFAULT_BINDINGS_SAITEK_WHEEL_AND_PANEL = 'C:/.../Farming Simulator 19/profileTemplate/inputBindingDefault_SaitekWheelAndPanel.xml',
    DEFAULT_BINDINGS_PANEL = 'C:/.../Farming Simulator 19/profileTemplate/inputBindingDefault_SidePanel.xml',
    DEFAULT_BINDINGS_XBOX = 'C:/.../Farming Simulator 19/profileTemplate/inputBindingDefault_Gamepad.xml',
    DEFAULT_BINDINGS_ANDROID = 'C:/.../Farming Simulator 19/profileTemplate/inputBindingDefaultAndroid.xml',
    DEFAULT_BINDINGS_KB_MOUSE = 'C:/.../Farming Simulator 19/profileTemplate/inputBindingDefault_KeyboardMouse.xml',
    DEFAULT_BINDINGS_SAITEK_PANEL = 'C:/.../Farming Simulator 19/profileTemplate/inputBindingDefault_SaitekPanel.xml',
    DEFAULT_BINDINGS_GAMEPAD = 'C:/.../Farming Simulator 19/profileTemplate/inputBindingDefault_Gamepad.xml',
    DEFAULT_BINDINGS_SAITEK_WHEEL = 'C:/.../Farming Simulator 19/profileTemplate/inputBindingDefault_SaitekWheel.xml',
    USER_BINDINGS = 'C:/Users/.../Documents/My Games/FarmingSimulator2019/inputBinding.xml',
    ACTION_DEFINITIONS = 'C:/.../Farming Simulator 19/dataS/inputActions.xml',
    DEFAULT_BINDINGS_WHEEL_AND_PANEL = 'C:/.../Farming Simulator 19/profileTemplate/inputBindingDefault_WheelAndPanel.xml',
    DEFAULT_BINDINGS_IOS = 'C:/.../Farming Simulator 19/profileTemplate/inputBindingDefaultIOS.xml'
}
InputBinding.MOUSE_AXIS_NAMES = {
    0 = 'AXIS_X',
    1 = 'AXIS_Y'
}
InputBinding.COMBO_MASK_CONSOLE_COMMAND_3 = 4.000000
InputBinding.INPUTTYPE_KEYBOARD = 1.000000
InputBinding.version = 4.000000
InputBinding.INPUTTYPE_MOUSE_AXIS = 4.000000
...
InputBinding.MOUSE_MOVE_LIMIT = 4.000000
InputBinding.COMBO_MASK_MOUSE_COMMAND_2 = 2.000000
InputBinding.COMBO_MASK_MOUSE_COMMAND_1 = 1.000000
InputBinding.NO_EVENT_TARGET = 0.000000
InputBinding.INPUTTYPE_GAMEPAD_AXIS = 6.000000
InputBinding.COMBO_MASK_CONSOLE_COMMAND_2 = 2.000000
...
InputBinding.INPUT_MODE_CHANGE_THRESHOLD = 0.500000
InputBinding.GAMEPAD_AXES = {
    AXIS_4 = 3.000000,
    AXIS_12 = 11.000000,
    AXIS_1 = 0.000000,
    AXIS_11 = 10.000000,
    AXIS_6 = 5.000000,
    HALF_AXIS_3 = 12.000000,
    AXIS_3 = 2.000000,
    AXIS_13 = 12.000000,
    AXIS_8 = 7.000000,
    HALF_AXIS_1 = 10.000000,
    AXIS_5 = 4.000000,
    HALF_AXIS_2 = 11.000000,
    AXIS_2 = 1.000000,
    AXIS_10 = 9.000000,
    AXIS_7 = 6.000000,
    AXIS_9 = 8.000000
}
InputBinding.MOUSE_MOTION_SCALE_X_DEFAULT = 1.000000
InputBinding.COMBO_MASK_CONSOLE_COMMAND_1 = 1.000000
InputBinding.MOUSE_MOTION_SCALE_Y_DEFAULT = 1.000000

InputBinding.DEVICE_CATEGORY_DEFAULTS_PATHS = {
    0 = 'C:/.../Farming Simulator 19/profileTemplate/inputBindingDefault_Gamepad.xml',
    2 = 'C:/.../Farming Simulator 19/profileTemplate/inputBindingDefault_Wheel.xml',
    5 = 'C:/.../Farming Simulator 19/profileTemplate/inputBindingDefault_SaitekPanel.xml',
    3 = 'C:/.../Farming Simulator 19/profileTemplate/inputBindingDefault_Joystick.xml',
    255 = 'C:/.../Farming Simulator 19/profileTemplate/inputBindingDefault_SaitekWheelAndPanel.xml',
    1 = 'C:/.../Farming Simulator 19/profileTemplate/inputBindingDefault_Gamepad.xml',
    254 = 'C:/.../Farming Simulator 19/profileTemplate/inputBindingDefault_WheelAndPanel.xml',
    4 = 'C:/.../Farming Simulator 19/profileTemplate/inputBindingDefault_SaitekWheel.xml'
}
...
InputBinding.INPUTTYPE_GAMEPAD = 5.000000
InputBinding.SYMBOL_AFFIX_NEGATIVE = '_2'
InputBinding.GAMEPAD_AXIS_NAMES = {
    0 = 'AXIS_1',
    2 = 'AXIS_3',
    5 = 'AXIS_6',
    12 = 'HALF_AXIS_3',
...
InputBinding.INPUTTYPE_MOUSE_BUTTON = 2.000000
InputBinding.MOUSE_AXIS_X = 1.000000
InputBinding.MOUSE_AXIS_NONE = 0.000000
InputBinding.INPUTTYPE_NONE = 0.000000
...
InputBinding.COMBO_MASK_MOUSE_COMMAND_3 = 4.000000
InputBinding.MOUSE_BUTTONS = {
    MOUSE_BUTTON_MIDDLE = 2.000000,
    MOUSE_BUTTON_WHEEL_UP = 4.000000,
    MOUSE_BUTTON_RIGHT = 3.000000,
    MOUSE_BUTTON_X2 = 7.000000,
    MOUSE_BUTTON_LEFT = 1.000000,
    MOUSE_BUTTON_X1 = 6.000000,
    MOUSE_BUTTON_WHEEL_DOWN = 5.000000
}
...
function InputBinding:resolveMissingDeviceByNameToBinding() end
...
function InputBinding:resolveDefaultDeviceToBinding() end
...
function InputBinding:resolveFirstDeviceOfCategoryToBinding() end
...
function InputBinding:getMaximumBindingCountForDeviceId() end
...
function InputBinding:resolveSameIdDeviceWithPrefixToBinding() end

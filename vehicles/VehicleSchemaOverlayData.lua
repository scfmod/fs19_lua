...
function VehicleSchemaOverlayData:superClass() end
function VehicleSchemaOverlayData:new() end
function VehicleSchemaOverlayData:addAttacherJoint() end
function VehicleSchemaOverlayData:isa() end
function VehicleSchemaOverlayData:copy() end
function VehicleSchemaOverlayData:class() end